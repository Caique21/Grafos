...
public class Arrow extends Path
{
    ...
    public Arrow(double startX, double startY, double endX, double endY,String origem,String dest)
    {
        this(startX, startY, endX, endY, defaultArrowHeadSize,origem,dest);
    }
